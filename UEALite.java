 ...
 *
 * <p>Description: This is a port of the original Perl stemmer algoitum v1.03, authored by Marie-Claire Jenkins and Dr. Dan J Smith.</p>
 *
...
public class UEALite {
    ...
    ************************************************************************/
    ...
    public Word stem( String word ) {
        ...
        else if (word.endsWith( "uing" )) { stemmed_word = word.replaceFirst( "ing", "e" ); ruleno = 25.1; } 
